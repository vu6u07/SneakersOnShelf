...
public class ProductDTORestController  extends  BaseController{
	...
	public ResponseEntity<?> save(@RequestBody ProductInfoDTO product) {
		System.out.println(product.getName());
		Product product1 = new Product();
		product1.setId(product.getId());
		product1.setProductDetails(product.getProductDetails());
		Brand brand = brandService.findBrandById(Integer.parseInt(product.getBrand()));
		Category category = categoryService.findCategoryById(Integer.parseInt(product.getCategory()));
	...
	public ResponseEntity<?> save(@RequestParam("files") MultipartFile[] files) {
		try{
