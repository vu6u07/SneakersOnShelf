...
public interface OrderItemRepository extends JpaRepository<OrderItem, Integer> {
	...
	@Query(value = "SELECT new com.sos.entity.OrderItem(o.id, o.price, o.quantity, pd.id, pd.quantity, pd.size, p.name, p.sellPrice) FROM OrderItem o JOIN o.productDetail pd JOIN pd.product p WHERE o.id = :id")
