...
public interface OrderRepository extends JpaRepository<Order, UUID> {
	...
	@Query(value = "SELECT new com.sos.dto.PurchaseDTO(o.id, COUNT(oi.quantity), o.total, o.orderStatus, o.paymentStatus, o.createDate, o.updateDate) FROM Order o JOIN o.orderItems oi WHERE o.customerInfo.account.id = :accountId")
