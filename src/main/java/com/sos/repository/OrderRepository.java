...
public interface OrderRepository extends JpaRepository<Order, String> {
	...
	// Anonymous
	@Query(value = "SELECT new com.sos.dto.PurchaseInfoDTO(o.id, o.token, o.saleMethod, o.orderStatus, o.memberOffer, o.discount, o.surcharge, o.total, o.fee, o.fullname, o.email, o.phone, o.description, o.createDate, o.address, o.detailedAddress) FROM Order o WHERE o.id = :id AND o.token = :token")
	Optional<PurchaseInfoDTO> findPurchaseInfoDTO(String id, String token);

	// Logged User
	@Query(value = "SELECT new com.sos.dto.PurchaseInfoDTO(o.id, o.token, o.saleMethod, o.orderStatus, o.memberOffer, o.discount, o.surcharge, o.total, o.fee, o.fullname, o.email, o.phone, o.description, o.createDate, o.address, o.detailedAddress) FROM Order o WHERE o.id = :id AND o.account.id = :accountId")
	...
	// Admin
	@Query(value = "SELECT new com.sos.dto.PurchaseInfoDTO(o.id, o.token, o.saleMethod, o.orderStatus, o.memberOffer, o.discount, o.surcharge, o.total, o.fee, o.fullname, o.email, o.phone, o.description, o.createDate, o.address, o.detailedAddress) FROM Order o WHERE o.id = :id")
	...
	@Query(value = "SELECT new com.sos.entity.Order(o.id, o.orderStatus, o.saleMethod, o.memberOffer, o.discount, o.surcharge, o.total, o.districtId, o.wardCode) FROM Order o WHERE o.id = :id")
	Optional<Order> findStagingOrder(String id);
	
	//for update order address
	@Query(value = "SELECT new com.sos.entity.Order(o.id, o.orderStatus, o.saleMethod, o.memberOffer, o.discount, o.surcharge, o.total, o.districtId, o.wardCode) FROM OrderItem oi JOIN oi.order o WHERE oi.id = :orderItemId")
